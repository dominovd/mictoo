// What's new page — pt wrapper. Renders the shared WhatsNewPage component
// with locale="pt". Entries come from data/changelog.json with per-entry
// translations picked by locale.

import WhatsNewPage from '@/components/WhatsNewPage'

export const metadata = {
  title: "Novidades — Últimas atualizações do Mictoo",
  description: "Últimas atualizações da ferramenta gratuita de transcrição com IA do Mictoo: novos recursos, integrações e mudanças no produto.",
  alternates: {
    canonical: 'https://mictoo.com/pt/whats-new',
    languages: {
  ...
  openGraph: {
    title: "Novidades — Últimas atualizações do Mictoo",
    description: "Últimas atualizações da ferramenta gratuita de transcrição com IA do Mictoo: novos recursos, integrações e mudanças no produto.",
    url: 'https://mictoo.com/pt/whats-new',
    siteName: 'Mictoo',
    type: 'website',
