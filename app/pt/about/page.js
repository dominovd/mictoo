...
export const metadata = {
  ...
  openGraph: {
    title: "Sobre o Mictoo — ferramenta grátis de transcrição IA",
    description: "Quem está por trás do Mictoo, uma ferramenta grátis de transcrição de áudio e vídeo com IA. Como funciona, como ganhamos dinheiro, e o que fazemos (e não fazemos) com seus arquivos.",
    url: "https://mictoo.com/pt/about",
    siteName: "Mictoo",
    type: "website",
