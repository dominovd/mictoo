...
export const metadata = {
  ...
  openGraph: {
    title: "FLAC to MP3, free online converter | Mictoo",
    description: "Convert FLAC to MP3 free online. Shrink lossless FLAC down to 128 kbps MP3 in seconds. No signup, no watermark. Up to 25 MB.",
    ...
    <LandingLayout
      ...
      deepDive={
        <article className="prose-content">
          <h2>FLAC to MP3 is the archive-to-everyday-use conversion</h2>
          <p>
            People who care about their music collection tend to store
            the archive copy as FLAC. Lossless compression preserves
            every sample of the original CD or hi-res master while taking
            roughly half the space of WAV. That is the right format for
            the long-term archive on a NAS or external drive.
          </p>
          <p>
            The problem starts when you want to actually listen to those
            tracks on a phone, in a car, or through a Bluetooth speaker.
            A 30-minute FLAC album is 200-300 MB. Synced to a phone, that
            eats storage. Streamed over Bluetooth, FLAC needs codecs the
            device may not have. MP3 at 128 kbps is one-tenth the size
            and plays on literally every device.
          </p>
          <h3>The keep-the-master, convert-the-copy pattern</h3>
          <p>
            The smart workflow is two-tier. Your FLAC sits on the
            archive drive, never touched, the canonical copy. You
            generate MP3 versions for everyday playback (phone library,
            car USB stick, casual streaming). When you get new
            playback gear or formats change, you re-encode from the
            FLAC master, not from the MP3 derivative. The MP3 is
            disposable; the FLAC is permanent.
          </p>
          <h3>The 16-bit vs 24-bit hi-res question</h3>
          <p>
            If your FLAC is 24-bit 96 kHz (a hi-res download from
            Bandcamp or Qobuz, for example), the source is much larger
            than a typical 16-bit 44.1 kHz CD-quality FLAC. The MP3
            output ends up the same size and quality either way, because
            MP3 maxes out at 16-bit equivalent. The extra bit depth and
            sample rate in the source are discarded in the encode. They
            still matter for the archive copy, not for the MP3 you carry
            around.
          </p>
          <h3>If you also want lossless playback in Apple Music</h3>
          <p>
            FLAC does not play in iTunes or Apple Music. If your goal is
            lossless playback in Apple ecosystem, convert FLAC to ALAC
            (Apple Lossless) instead of MP3. Same lossless audio, similar
            file size, native Apple playback. Our converter does not
            output ALAC, but Audacity (free, all platforms) does.
          </p>
        </article>
      }
      relatedLinks={[
