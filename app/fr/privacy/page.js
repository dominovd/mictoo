...
export const metadata = {
  ...
  openGraph: {
    title: "Politique de confidentialité — Mictoo",
    description: "Politique de confidentialité de Mictoo. Nous ne stockons ni vos fichiers audio ni vos transcriptions.",
    url: "https://mictoo.com/fr/privacy",
    siteName: "Mictoo",
    type: "website",
      ...
      sections={[
        {
          ...
          body: "Mictoo ne demande aucun compte et ne collecte aucune information personnelle. Lorsque vous téléchargez un fichier, votre navigateur l'envoie directement à Vercel Blob, le stockage de fichiers de Vercel hébergé aux États-Unis. Le fichier y reste brièvement, le temps que notre serveur le transmette à l'API Whisper de Groq (hébergée aux États-Unis) pour la transcription, avec l'API Whisper d'OpenAI conservée comme fallback automatique si Groq est brièvement indisponible. Il est ensuite automatiquement supprimé de Vercel Blob dès la fin de la transcription — généralement en moins d'une minute. Une tâche de nettoyage horaire balaye les uploads résiduels qui n'auraient pas été supprimés immédiatement. Mictoo ne conserve aucune copie permanente de votre audio, vidéo ou transcription sur ses propres serveurs.",
        },
        {
          heading: '2. Traitement des fichiers et notre fournisseur IA',
          body: "Les fichiers sont transmis en HTTPS à l'API Whisper de Groq et traités en temps réel sur une infrastructure située aux États-Unis. Selon la politique de données de Groq, votre audio n'est pas utilisé pour l'entraînement des modèles. Dans le cas rare où Groq est indisponible, la requête bascule automatiquement vers l'API Whisper d'OpenAI ; OpenAI n'utilise pas non plus les données API pour l'entraînement et les conserve pendant 30 jours maximum à des fins de surveillance anti-abus avant suppression. Mictoo ne conserve aucune copie de l'audio ni de la transcription une fois votre session de navigation terminée.",
        },
        {
