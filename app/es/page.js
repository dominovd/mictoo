  ...
  return (
    <LandingLayout
      ...
      whyUse={{ title: 'Por qué Mictoo', bullets: [
        ...
        { title: "Resumen con IA incluido", desc: "Después de cada transcripción, generamos un resumen gratuito con los puntos clave y las acciones a seguir. Los competidores suelen cobrar entre 15 y 20 $/mes por esta función. Sin clic extra, sin invitación a pagar." },
        ...
        { title: "Chatea con tu transcripción", desc: "Pregunta cualquier cosa sobre una transcripción que hayas creado y recibe respuestas con marcas de tiempo clicables. Gratis, solo requiere iniciar sesión." },
      ]}}
