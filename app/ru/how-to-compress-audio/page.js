...
export const metadata = {
  ...
  openGraph: {
    title: "Как сжать аудио для расшифровки — Бесплатные способы | Mictoo",
    description: "Три бесплатных способа уменьшить аудио- или видеофайл до 25 МБ для расшифровки: извлечь аудио, снизить битрейт или разбить файл. Без установки софта.",
    url: "https://mictoo.com/ru/how-to-compress-audio",
    siteName: "Mictoo",
    type: "website",
    ...
    <section className="max-w-2xl mx-auto px-4 py-16">
      ...
      <div className="space-y-12 text-slate-600 text-sm leading-relaxed">
        ...
        <div>
          ...
          <p className="mb-2">Используйте наш собственный браузерный конвертер — перетащите файл, получите MP3 за несколько секунд. Бесплатно, без регистрации, без водяного знака:</p>
          <ul className="list-disc pl-5 space-y-1">
            <li><a href="/mp4-to-mp3" className="text-brand-600 hover:underline">MP4 в MP3</a> — извлекает аудиодорожку из любого MP4-видео.</li>
            <li><a href="/webm-to-mp3" className="text-brand-600 hover:underline">WEBM в MP3</a> — для YouTube-загрузок и записей экрана.</li>
            <li><a href="/wav-to-mp3" className="text-brand-600 hover:underline">WAV в MP3</a> — сжимает несжатый WAV в управляемый MP3.</li>
          </ul>
