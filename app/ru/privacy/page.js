      ...
      sections={[
        {
          ...
          body: 'Mictoo не требует создания аккаунта и не собирает персональные данные. Когда вы загружаете файл, он отправляется напрямую в API ИИ для распознавания. Мы не храним, не логируем и не сохраняем ваши аудио- и видеофайлы.',
        },
        {
          heading: '2. Обработка файлов',
          body: 'Загруженные файлы передаются по защищённому каналу на серверы нашего поставщика ИИ для распознавания речи. Файлы обрабатываются в режиме реального времени и не хранятся ни на наших серверах, ни на серверах поставщика дольше одного API-запроса.',
        },
        {
