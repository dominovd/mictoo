...
//
// Locale coverage: IT only for now. fr/de/es/ru/it/pt/pl/ja/ko homes still
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Mictoo utilizza Whisper large-v3 di OpenAI, uno dei modelli di riconoscimento vocale aperti più precisi disponibili. La precisione dipende dalla qualità audio e dall’accento, ma supera tipicamente il 95% per registrazioni chiare.",
  },
  {
    q: 'Quali lingue sono supportate?',
    a: "Whisper supporta oltre 50 lingue tra cui inglese, spagnolo, francese, tedesco, portoghese, russo, ucraino, giapponese, cinese, arabo e altro. La lingua viene rilevata automaticamente, oppure puoi sceglierne una manualmente nel modulo di caricamento.",
  },
  {
    q: 'Il mio file è memorizzato sui vostri server?',
    a: "No. I file vengono trasmessi direttamente all’API Whisper di Groq (ospitata negli Stati Uniti) per la trascrizione, con l’API Whisper di OpenAI mantenuta come fallback automatico, e non vengono memorizzati sui server di Mictoo. Nessuno dei fornitori utilizza l’audio API per l’addestramento del modello; OpenAI conserva i dati per al massimo 30 giorni di monitoraggio degli abusi prima della cancellazione.",
  },
  {
  ...
  },
  {
    ...
    a: 'Mictoo supporta MP3, MP4, WAV, M4A, OGG, WEBM, FLAC, AAC, MOV e MPEG. Vengono accettati file audio e video; per il video estraiamo la traccia audio lato server.',
  },
  {
    q: 'Quanto tempo richiede la trascrizione?',
    a: 'La maggior parte dei file termina in pochi secondi. Un file audio di 10 minuti richiede tipicamente da 15 a 30 secondi; un podcast di 60 minuti è completato in circa un minuto.',
  },
  {
    q: 'Posso modificare la trascrizione dopo che è stata generata?',
    a: 'Sì. La trascrizione è completamente modificabile nel tuo browser prima di copiarla o scaricarla. Non è necessario alcun account per salvare le modifiche nella tua sessione locale.',
  },
  {
  ...
  },
  {
    ...
    a: "Mictoo è costruito sul modello Whisper large-v3 di OpenAI, servito da Groq per velocità con OpenAI come fallback. È lo stesso modello di riconoscimento vocale che alimenta le funzionalità vocali di ChatGPT e molti servizi professionali di sottotitolazione.",
  },
]
...
const webAppSchema = {
  ...
  url: 'https://mictoo.com/it',
  description:
    'Strumento di trascrizione audio e video online gratuito alimentato da OpenAI Whisper. Nessuna registrazione richiesta. Supporta oltre 50 lingue.',
  applicationCategory: 'UtilityApplication',
  operatingSystem: 'Web',
  browserRequirements: 'Richiede un browser moderno con JavaScript abilitato.',
...
export default function ItHome() {
  return (
    <>
      ...
      <section className="bg-gradient-to-b from-brand-50/40 via-slate-100/60 to-slate-100 pt-16 pb-16 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-slate-600 mb-7 max-w-2xl mx-auto">
            Trascrizioni accurate in pochi secondi. Carica MP3, MP4, WAV e altro. Nessun account richiesto.
          </p>
        ...
        <div id="tool" className="max-w-2xl mx-auto mt-10 scroll-mt-20">
          <UploadZone defaultLanguage="it" locale="it" />
        </div>
      </section>
      ...
      */}
      <section className="bg-slate-100 border-b border-slate-200 pb-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">Converti qualsiasi file in testo</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
            {[
              { href: '/it/transcribe-mp3-to-text',   label: 'MP3 in Testo',        icon: Icons.music },
              { href: '/it/transcribe-video-to-text', label: 'Video in Testo',      icon: Icons.video },
              { href: '/it/wav-to-text',              label: 'WAV in Testo',        icon: Icons.waveform },
              { href: '/it/meeting-transcription',    label: 'Trascrizione Riunioni', icon: Icons.users },
              { href: '/it/podcast-transcription',    label: 'Trascrizione Podcast', icon: Icons.mic },
              { href: '/it/voice-memo-to-text',       label: 'Memo Vocali in Testo', icon: Icons.editPen },
            ].map(({ href, label, icon }) => (
              <a
                key={href}
                href={href}
      ...
      {/* ────────────────── COME FUNZIONA MICTOO ────────────────── */}
      <section id="how-it-works" className="bg-white border-y border-slate-100 py-16 px-4 scroll-mt-20">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-10">Come funziona Mictoo</h2>
              ...
              {[
                {
                  ...
                  desc: 'Trascina e rilascia o scegli un file audio o video. MP3, MP4, WAV, M4A e altro.',
                },
                {
                  step: 2,
                  icon: Icons.sparkles,
                ...
                },
                {
                  ...
                  desc: 'Modifica, riassumi, traduci e scarica la tua trascrizione come TXT, DOCX, PDF o SRT.',
                },
      ...
      {/* ────────────────── PERCHÉ SCEGLIERE MICTOO ────────────────── */}
      <section className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-slate-900 mb-8">Perché scegliere Mictoo?</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            {
              icon: Icons.target,
              title: 'Alta precisione',
              desc: 'Whisper large-v3 fornisce trascrizioni accurate anche con accenti e rumori di fondo.',
            },
            {
              icon: Icons.bolt,
              title: 'Risultati rapidi',
              desc: 'Ottieni trascrizioni in pochi secondi, non in ore. Un file di 30 minuti di solito termina in circa un minuto.',
            },
            {
              icon: Icons.lock,
              title: 'Privato per design',
              desc: 'I file vengono elaborati in modo sicuro e non vengono mai memorizzati sui nostri server. Nessun addestramento sui tuoi audio.',
            },
            {
              icon: Icons.globe,
              title: 'Oltre 50 lingue',
              desc: 'Trascrivi e traduci in oltre 50 lingue. Rilevamento automatico o seleziona la tua lingua.',
            },
          ].map(({ icon, title, desc }) => (
      ...
      {/* ────────────────── COSTRUITO PER OGNI VOCE ────────────────── */}
      <section className="bg-white border-y border-slate-100 py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-2xl font-bold text-slate-900 mb-8">Costruito per ogni voce</h2>
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3">
            {[
              {
                href: '/it/lecture-transcription',
                icon: Icons.cap,
                label: 'Studenti',
                desc: 'Trascrivi lezioni e materiali di studio. Concentrati sull\'apprendimento.',
              },
              {
                href: '/it/podcast-transcription',
                icon: Icons.mic,
                label: 'Podcaster',
                desc: 'Trasforma gli episodi in note dello show, blog e contenuti social.',
              },
              {
                href: '/it/interview-transcription',
                icon: Icons.newspaper,
                label: 'Giornalisti',
                desc: 'Trascrivi interviste rapidamente e verifica le citazioni con facilità.',
              },
              {
                href: '/it/meeting-transcription',
                icon: Icons.briefcase,
                label: 'Team',
                desc: 'Documenta le riunioni e condividi trascrizioni utili.',
              },
              {
                href: '/it/free-srt-generator',
                icon: Icons.video,
                label: 'Creatori di contenuti',
                desc: 'Riutilizza audio e video in sottotitoli, articoli e altro.',
              },
      ...
      {/* ────────────────── TABELLA DI COMPARAZIONE UNIFICATA ──────────────────
      ...
      */}
      <section className="max-w-6xl mx-auto px-4 py-16">
        <h2 className="text-2xl font-bold text-slate-900 mb-3">Trascrizione gratuita senza abbonamento</h2>
        <p className="text-slate-600 mb-8 max-w-2xl">
          Come Mictoo si confronta con gli strumenti che le persone considerano solitamente. Clicca su qualsiasi riga per un confronto dettagliato delle funzionalità.
        </p>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl overflow-x-auto">
          <table className="w-full text-sm min-w-[820px] border-collapse">
            ...
            <tbody>
                ...
                <td className="px-5 py-5 border-t border-slate-100 align-middle">
                  <div className="inline-flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <div className="text-[11px] text-brand-700 font-medium">Gratuito per tutti</div>
                    </div>
                  </div>
                </td>
                {[
                  { yes: true, label: 'Gratuito da usare' },
                  { yes: true, label: 'Nessun account' },
                  { yes: true, label: 'Incluso' },
                  { yes: true, label: 'Oltre 50 lingue' },
                ].map(({ label }, i) => (
              ...
              {[
                {
                  name: 'Descript',    href: '/it/descript-alternative',    tag: 'Flusso di lavoro editor-first',
                  cells: ['Tier limitato',    'Registrazione richiesta', 'Add-on a pagamento',   'Limitato'],
                },
                {
                  name: 'Fireflies',   href: '/it/fireflies-alternative',   tag: 'Registratore di riunioni',
                  cells: ['Tier limitato',    'Registrazione richiesta', 'Tier pro',      'Limitato'],
                },
                {
                  name: 'TurboScribe', href: '/it/turboscribe-alternative', tag: 'Trascrizione occasionale',
                  cells: ['Limite giornaliero',        'Registrazione richiesta', 'Non incluso',  'Limitato'],
                },
                {
                  name: 'Otter',       href: '/it/otter-alternative',       tag: 'Note di riunioni dal vivo',
                  cells: ['Limite mensile',      'Registrazione richiesta', 'Tier pro',      'Limitato'],
                },
                {
                  name: 'Notta',       href: '/it/notta-alternative',       tag: 'Focus multi-lingua',
                  cells: ['Limite mensile',      'Registrazione richiesta', 'Tier pro',      'Ampio'],
                },
        ...
        <p className="text-xs text-slate-400 text-center mt-4">
          Solo un’istantanea. Le pagine dei prezzi cambiano; consulta il confronto collegato per i numeri attuali.
        </p>
      </section>
          ...
          <div className="relative flex flex-col md:flex-row items-center justify-center gap-6 md:gap-8 py-10 px-6 md:px-10 text-center md:text-left">
            ...
            <div className="min-w-0 flex-1 max-w-lg">
              <div className="font-bold text-white text-xl md:text-2xl leading-tight">
                Trascrivi il tuo file, gratis
              </div>
              <div className="text-sm text-white/85 mt-1.5">
                Trascina il tuo audio o video e ottieni una trascrizione accurata in pochi secondi.
              </div>
              ...
              <div className="mt-3 flex flex-wrap items-center justify-center md:justify-start gap-x-4 gap-y-1 text-[11px] text-white/80">
                <span className="inline-flex items-center gap-1">
                  <span className="w-3 h-3">{Icons.check}</span> Nessuna registrazione
                </span>
                <span className="inline-flex items-center gap-1">
                  <span className="w-3 h-3">{Icons.check}</span> Nessuna carta di credito
                </span>
                <span className="inline-flex items-center gap-1">
                  <span className="w-3 h-3">{Icons.check}</span> Oltre 50 lingue
                </span>
              </div>
            </div>
            ...
            >
              <span>Inizia a trascrivere</span>
