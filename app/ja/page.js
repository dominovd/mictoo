  ...
  return (
    <LandingLayout
      ...
      whyUse={{ title: 'Mictooを選ぶ理由', bullets: [
        ...
        { title: "AI 要約付き", desc: "文字起こしの後に GPT による要約を無料で自動生成します。要点とアクションアイテムが一目で分かります。競合サービスでは月額 15〜20 ドルの有料機能ですが、Mictoo では追加クリックも有料プランへの誘導もありません。" },
        { title: "28 言語に翻訳", desc: "ワンクリックで文字起こし全体をスペイン語、フランス語、ドイツ語、英語、ロシア語など 28 言語に翻訳します。元のタイムスタンプは保持されるため、翻訳済み SRT は音声と同期したままです。" },
        { title: "あなたのトランスクリプトとチャット", desc: "作成したトランスクリプトについて何でも質問でき、クリック可能なタイムスタンプ付きの回答を得られます。無料、サインインのみ必要。" },
      ]}}
