  ...
  return (
    <ConverterPageLayout
      ...
      steps={[
        ...
        { icon: 'download', title: 'Download the MP3',    desc: 'Get an MP3 that every player, phone, and DAW recognises.' },
      ]}
      ...
      whyCards={[
        ...
        { icon: 'fileAudio',title: 'MP3 plays everywhere',    desc: 'Once converted, the file works on Mac, Linux, iPhone, Android, and every music player.' },
      ...
      faq={[
        { q: 'Is the WMA to MP3 converter free?', a: 'Yes. Files up to 25 MB anonymously, 60 MB signed in. No watermark, no upgrade prompts.' },
