...
export default function ChatPanel({
  ...
  if (!isAuth) {
    return (
      <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-4 mt-4 mb-6 flex items-center justify-between gap-3">
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white shadow-sm mt-4 mb-6 overflow-hidden">
